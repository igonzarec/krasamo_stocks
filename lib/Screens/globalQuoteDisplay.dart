      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.data == null) {
          ...
          return Padding(
            ...
            child: Row(
              children: [
                Text(globalQuote.symbolName, style: TextStyle(color: Colors.white),),
                Spacer(flex: 1,),
                Text(globalQuote.price, style: TextStyle(color: Colors.white),),
                Spacer(flex: 2),
                Padding(
                  ...
                  child: Image(
                    height: 15,
                    fit: BoxFit.contain,
                    image: AssetImage("Assets/Up_arrow_icon_3x.png"),
                  ),
                ),
                Text(globalQuote.low, style: TextStyle(color: Colors.white),),
                Spacer(flex: 1),
                Padding(
                  ...
                  child: Image(
                    height: 15,
                    fit: BoxFit.contain,
                    image: AssetImage("Assets/Down_arrow_icon_3x.png"),
                  ),
                ),
                Text(globalQuote.high, style: TextStyle(color: Colors.white),),
              ],
